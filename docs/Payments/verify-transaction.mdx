...
import {verifyTransactionApi, verifyTransactionResponse} from "../../src/data/PaymentDocs/data.js"
...
<Accordion 
    ...
    parameters={true} 
    endpoint={"https://sandbox-api-d.squadco.com/transaction/verify/{{transaction_ref}}"} 
    method={"GET"} 
