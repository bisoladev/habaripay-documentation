...
import {walletAPI, walletResponse} from "../src/data/WalletBalanceDocs/data.js";
...
<Accordion 
    ...
    method={"GET"} 
    header={"This endpoint allows you get your Squad Wallet Balance. Amount is in KOBO"} 
/>
