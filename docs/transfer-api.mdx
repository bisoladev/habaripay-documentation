...
import {accountLookupAPI,
        ...
        } from "../src/data/PaymentLinkDocs/data.js";
...
<Accordion 
    ...
    method={"POST"} 
    summary={"This is for movement of funds from Squad Wallet to any bank account (GTB at the moment)"}
/>
...
<Accordion 
    ...
    method={"GET"} 
    header={"This API gets the details of all transfers you have done from your Squad Wallet "} 
/>
