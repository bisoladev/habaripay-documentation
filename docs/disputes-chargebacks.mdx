...
import {getAllDisputesResponse, getUploadUrlAPI, resolveDisputesAPI} from "../src/data/ChargebackDisputeDocs/data.js";
...
<Accordion 
    ...
    method={"GET"} 
    header={"All you need to do is  make a get request with your private/secret key"} 
/>
...
<Accordion 
    ...
    parameters={true} 
    endpoint={"https://sandbox-api-d.squadco.com/dispute/upload-url/:ticket_id/:file_name"} 
    method={"GET"} 
    header={"All you need to do is  make a get request with your private/secret key"} 
/>
...
<Accordion 
    ...
    method={"GET"} 
    header={"This API is used to resolve a dispute by either accepting or rejecting it. "} 
/>
